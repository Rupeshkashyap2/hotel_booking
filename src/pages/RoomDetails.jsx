    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
                ...
                <button
                    type="submit"
                    className="bg-primary hover:bg-primary active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-8 py-3 text-base cursor-pointer"
                >
                    Check Availability
                </button>
            ...
            <div>
                <p className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
                    ...
                    of guests to get the exact price for the group.
                </p>
            </div>
            ...
            <div className="flex flex-col items-start gap-4">
                ...
                <button className="px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary active:scale-95 transition-all cursor-pointer">
                    Contact Now
                </button>
