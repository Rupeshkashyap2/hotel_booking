...
const ListRoom = () =>{
    ...
    return (
        <div>
         <Title align='left' font='outfit' title='List Rooms'
          subTitle='Manage your hotel rooms, update room details, and keep track of all your available listings in one place.'/>
        
        <p className="text-gray-500 my-8">All Rooms</p>

        <div className="w-full max-w-3xl text-left rounded-lg max-h-80 overflow-y-scroll mt-3">
